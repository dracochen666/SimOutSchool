...
//        reasonTextView.font = .systemFont(ofSize: 15)
        ...
        let attachStackView = UIStackView(arrangedSubviews: [attachlabel,attachImageView1,attachImageView2,attachImageView3])
        attachStackView.axis = .vertical
        attachStackView.distribution = .equalSpacing
        
        //整体stackview
        let stackview = UIStackView(arrangedSubviews: [isVaccinationLabel,typeLabel,leaveDateLabel,addressLabel,riskLabel,specificDateLabel,reasonLabel,attachStackView])
